...
# scons co=1 b=GccOpt ts=projects/TissueBoundaries/test/TestCompetingPopulations_Loop.hpp
#
...
do
	...
	echo $start_sim
    	...
    	nice -20 ../build/optimised/TestCompetingPopulations_LoopRunner -run_index $start_sim -num_runs $offset_num_runs > output/GM_run_${i}_output.txt 2>&1 &
done
