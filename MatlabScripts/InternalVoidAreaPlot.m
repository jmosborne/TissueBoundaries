...
hold on;
plot(timeData,VertexJaggedArea,'-','linewidth',1.5,'color',1/255*[23, 63, 95])
plot(timeData,VertexSmoothArea,':','linewidth',2,'color',1/255*[23, 63, 95])
plot(timeData,VertexCurvedArea,'--','linewidth',1.5,'color',1/255*[23, 63, 95])

plot(timeData,NodeDefaultArea,'-','linewidth',1.5,'color',1/255*[60, 174, 163])
plot(timeData,NodeLargeArea,':','linewidth',2,'color',1/255*[60, 174, 163])
plot(timeData,NodeSmallArea,'--','linewidth',1.5,'color',1/255*[60, 174, 163])

plot(timeData,meshGhostArea,'-','linewidth',1.5,'color',1/255*[237, 85, 59])
plot(timeData,meshNoGhostInfArea,':','linewidth',2,'color',1/255*[237, 85, 59])
plot(timeData,meshNoGhostFinArea,'--','linewidth',1.5,'color',1/255*[237, 85, 59])
hold off;
